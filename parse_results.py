...
def parse_results(filename):
    ...
    #print("")
    return (val_acc1, val_acc5, tes_acc1, tes_acc5)
...
if __name__ == '__main__':
    ...
    EXP_LIST=[0.35, 0.5, 0.6, 0.75, 1.0]
    C_LIST = [0.01]
    NEL_LIST = [1, 2, 3]
    WGT_LIST=[0]
    KEEP_PROB_LIST=[1.0]
            ...
            for WGT in WGT_LIST:
              ...
              for KPROB in KEEP_PROB_LIST:
                ...
                for LR in LEARNING_RATE_LIST:
                  ...
                  val_acc1, val_acc5, tes_acc1, tes_acc5 = parse_results(filename)
                ...
                #print('')
              #print('')
            print(str(max_val_acc1)+' / '+str(max_val_acc5)+'\t'+str(max_tes_acc1)+' / '+str(max_tes_acc5)+'\t'+str(max_kp)+' / '+str(max_lr))
            #print('')
            #print('')
        print('')
